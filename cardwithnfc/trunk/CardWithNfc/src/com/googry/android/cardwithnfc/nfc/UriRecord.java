...
public class UriRecord implements ParsedRecord {
	...
	public int getType() {
		Log.i("NFC", "UriRecord getType()");
		return ParsedRecord.TYPE_URI;
	}

	public Uri getUri() {
		Log.i("NFC", "UriRecord getUri()");
		return mUri;
	}

	public static UriRecord parse(NdefRecord record) {
		Log.i("NFC", "UriRecord parse");
	...
	private static UriRecord parseAbsolute(NdefRecord record) {
		Log.i("NFC", "UriRecord parseAbsolute()");
	...
	private static UriRecord parseWellKnown(NdefRecord record) {
		Preconditions.checkArgument(Arrays.equals(record.getType(),
				NdefRecord.RTD_URI));
		Log.i("NFC", "UriRecord parseWellKnown");
		byte[] payload = record.getPayload();
